    ...
    internal class SecondUI : UIElement
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            if (!Main.playerInventory)
            {
                ...
                if ((boss != null && boss.active) != RevolutionsPlayer.lastHthBarStatus && Revolutions.Settings.extraAI) RevolutionsPlayer.HthBarTimer = 30;
                float drawPosFix = 0;
                SoundEffect soundEffect = Revolutions.mod.GetSound("Sounds/Custom/sword");
                if (RevolutionsPlayer.HthBarTimer == 10 && boss != null) soundEffect.Play();
